  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        _push(`<div class="${ssrRenderClass([unref(story).backgroundColor, "rounded-2xl shadow-xl"])}"><div class="relative p-8"><div class="absolute left-[-20px] right-[-20px] top-1/2 -translate-y-1/2 flex justify-between pointer-events-none">`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/stories/${unref(previousStoryId)}`,
          class: ["p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg hover:bg-white transition-all transform hover:scale-105 pointer-events-auto", { "pointer-events-none": !unref(previousStoryId) }],
          title: "Previous story"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(ChevronLeft), {
                class: ["h-6 w-6 text-gray-700", { "opacity-30": !unref(previousStoryId) }]
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/stories/${unref(nextStoryId)}`,
          class: ["p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg hover:bg-white transition-all transform hover:scale-105 pointer-events-auto", { "pointer-events-none": !unref(nextStoryId) }],
          title: "Next story"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(ChevronRight), {
                class: ["h-6 w-6 text-gray-700", { "opacity-30": !unref(nextStoryId) }]
              }, null, _parent2, _scopeId));
            } else {
              return [
...
//# sourceMappingURL=_id_-nMWjH176.mjs.map
