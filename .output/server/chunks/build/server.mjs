import { defineComponent, ref, getCurrentInstance, provide, createElementBlock, hasInjectionContext, inject, toRef, isRef, defineAsyncComponent, h, computed, unref, Suspense, Fragment, createApp, shallowReactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, $ as $fetch, m as createHooks, n as executeAsync, o as setCookie, p as getHeader, c as createError$1, t as toRouteMatcher, q as createRouter$1, r as defu, v as destr, x as klona, y as parse, z as getRequestHeader, A as isEqual, B as getCookie, C as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BzcwUU6y.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-5vyQz4nE.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import('./signup-DZkHsEmc.mjs')
  },
  {
    name: "confirm",
    path: "/confirm",
    component: () => import('./confirm-C_MiJGHq.mjs')
  },
  {
    name: "generate",
    path: "/generate",
    component: () => import('./generate-B0FhudqL.mjs')
  },
  {
    name: "stories-id",
    path: "/stories/:id()",
    component: () => import('./_id_-nMWjH176.mjs')
  },
  {
    name: "stories",
    path: "/stories",
    component: () => import('./index-CE5hufm8.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BZWO1qkH.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-tjF5xxKp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-4uZX9u5f.mjs'));
...
export { _export_sfc as _, useRouter as a, __nuxt_component_1$1 as b, useRoute as c, useNuxtApp as d, entry$1 as default, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useSupabaseUser as u };
