...
import { b as useRoute, a as useRouter, u as useSupabaseUser } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="https://api.dicebear.com/7.x/personas/svg?seed=kintales&amp;backgroundColor=b9e6fe" alt="Kintales" class="w-10 h-10 rounded-full shadow-sm group-hover:scale-110 transition-transform duration-300"${_scopeId}><span class="text-2xl font-bold text-gray-900"${_scopeId}>Kintales</span>`);
          } else {
            return [
              createVNode("img", {
...
//# sourceMappingURL=default-DUInUW2I.mjs.map
