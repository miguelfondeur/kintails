import { defineComponent, hasInjectionContext, inject, ref, getCurrentInstance, provide, createElementBlock, toRaw, computed, isRef, isReactive, toRef, reactive, effectScope, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, defineAsyncComponent, h, unref, Suspense, Fragment, createApp, shallowReactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, mergeProps, withCtx, useSSRContext } from 'vue';
import { h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, $ as $fetch, m as createHooks, n as executeAsync, o as setCookie, p as getHeader, c as createError$1, t as toRouteMatcher, q as createRouter$1, r as defu, v as destr, x as klona, y as getRequestHeader, z as isEqual, A as getCookie, B as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-ICqrDu1g.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-4LVOxdhg.mjs')
  },
  {
    name: "avatar",
    path: "/avatar",
    component: () => import('./avatar-8kOf_wwn.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import('./signup-z4tYos90.mjs')
  },
  {
    name: "confirm",
    path: "/confirm",
    component: () => import('./confirm-BwFAschi.mjs')
  },
  {
    name: "stories",
    path: "/stories",
    component: () => import('./stories-H3toEgoZ.mjs'),
    children: [
      {
        name: "stories-id",
        path: ":id()",
        component: () => import('./_id_-qaWcuvm1.mjs')
      }
    ]
  },
  {
    name: "generate",
    path: "/generate",
    component: () => import('./generate-zOlxoBJ4.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DUInUW2I.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-j27gqA8d.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-WATXQ9aP.mjs'));
...
export { _export_sfc as _, useRouter as a, useRoute as b, __nuxt_component_0$1 as c, defineStore as d, entry$1 as default, useNuxtApp as e, useRuntimeConfig as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, storeToRefs as s, tryUseNuxtApp as t, useSupabaseUser as u };
